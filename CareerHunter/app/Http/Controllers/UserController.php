...
class UserController extends Controller
{
    ...
    public function loker(Request $r)
    {
        ...
        if ($jenis_pekerjaan || $r->get("usia_min"))
        {
            $loker = DB::select(
    ...
    public function ajukanPosisi($user_id,$loker_id)
    {
        ...
        DB::insert("INSERT INTO request_posisi (user_id,loker_id) VALUES (?,?)",[$user_id,$loker_id]);
        
        return redirect()->route("loker.lihat",["id"=>$loker_id])->with("success","Request dikirim silahkan tunggu");
    }

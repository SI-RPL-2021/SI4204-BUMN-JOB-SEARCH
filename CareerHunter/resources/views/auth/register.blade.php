        ...
        <div class="bg-transparent p-4" style="">
            ...
            <form method="post" enctype="multipart/form-data" action="{{route("process.register")}}">
                ...
                <div class="mb-3">
                    ...
                    <input class="w-25"name="nama_lengkap" required type="text" required class="form-control" style="border-radius:10px;background-color: #C2E2F5;"
                        id="a" placeholder="">
                </div>
                <div class="mb-3">
                    <label for="a" class="form-label">Email</label><br>
                    <input class="w-25" name="email" required type="email" required class="form-control" style="border-radius:10px;background-color: #C2E2F5;"
                        id="a" placeholder="">
                </div>
                <div class="mb-3">
                    <label for="a" class="form-label">No HP</label><br>
                    <input class="w-25" name="no_hp" required type="number" required class="form-control" style="border-radius:10px;background-color: #C2E2F5;"
                        id="a" placeholder="">
                </div>
                <div class="mb-3">

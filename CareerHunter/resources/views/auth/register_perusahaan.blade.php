...
@section('body')
    <div class="bg-white bg-gradient px-5 vh-100" style="padding-top:9rem;">
        ...
        <div class="shadow-sm bg-white p-4" style="border-top: 4px solid var(--bs-warning);">
            <p class="fw-bold">Register Perusahaan</p>
            <form method="post" enctype="multipart/form-data" action="{{route("process.perusahaan.register")}}">
                @csrf
                <div class="mb-3">
                    <label for="a" class="form-label">Nama Perusahaan</label>
                    <input name="nama_perusahaan" required type="text" required class="form-control" style="border-left: 4px solid var(--bs-warning);"
                        id="a" placeholder="">
                </div>
                <div class="mb-3">
                    <label for="a" class="form-label">Nama Penanggung Jawab</label>
                    <input name="nama_pj" required type="text" required class="form-control" style="border-left: 4px solid var(--bs-warning);"
                        id="a" placeholder="">
                </div>
                <div class="mb-3">
                    <label for="a" class="form-label">No HP Penanggung Jaab</label>
                    <input name="no_hp_pj" required type="number" required class="form-control" style="border-left: 4px solid var(--bs-warning);"
                        id="a" placeholder="">
                </div>
                <div class="mb-3">
                    <label for="a" class="form-label">Email Perusahaan</label>
                    <input name="email_perusahaan" required type="email" required class="form-control" style="border-left: 4px solid var(--bs-warning);"
                        id="a" placeholder="">
                </div>
                <div class="mb-3">
                    <label for="a" class="form-label">Nomor Perusahaan</label>
                    <input name="no_perusahaan" required type="number" required class="form-control" style="border-left: 4px solid var(--bs-warning);"
                        id="a" placeholder="">
                </div>
                <div class="mb-3">
                ...
                <a class="mb-5" href="{{route("auth.register")}}"">Register User</a>
            </form>
        </div>
    </div>
@endsection

                            ...
                            <div class="row">
                                <div class="col-2" style="min-width:200px;">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" value="semua" name="jenis_pekerjaan"
                                            id="flexRadioDefault1" {{($_GET["jenis_pekerjaan"] ?? "") == "semua" ? "checked":"" }}>
                                        <label class="form-check-label" for="flexRadioDefault1">
                                            Semua
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" value="fulltime" name="jenis_pekerjaan"
                                            id="flexRadioDefault2" {{(($_GET["jenis_pekerjaan"] ?? "") == "fulltime") ? "checked":"" }}>
                                        <label class="form-check-label" for="flexRadioDefault2">
                                            Full-Time
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" value="parttime" name="jenis_pekerjaan"
                                            id="flexRadioDefault3" {{(($_GET["jenis_pekerjaan"] ?? "") == "parttime") ? "checked":"" }}>
                                        <label class="form-check-label" for="flexRadioDefault3">
                                            Part-Time
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" value="internship" name="jenis_pekerjaan"
                                            id="flexRadioDefault4" {{(($_GET["jenis_pekerjaan"] ?? "") == "internship") ? "checked":"" }}>
                                ...
                                <div class="col" style="min-width:200px;">
                                    ...
                                    <div class="d-flex">
                                        <select required name="usia" class="form-control mt-2 mb-2">
                                            @for ($i = 18; $i < 60; $i++)
                                                <option value="{{ $i }}" {{(intval($_GET["usia"] ?? "") == $i) ? "selected":""}}>{{ $i }}</option>
                                            @endfor
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col" style="min-width:200px;">
                                    ...
                                    <div class="d-flex">
                                        <input required name="pengalaman" type="number" class="form-control mt-2 mb-2"
                                            value="{{$_GET["pengalaman"]??""}}"id="exampleFormControlInput1">
                                    </div>
                                </div>
                                ...
                                <div class="col" style="min-width:200px;">
                                    <label>Gaji</label>
                                    <div class="d-flex">
                                        <input required name="gaji" type="number" class="form-control mt-2 mb-2"
                                            value="{{$_GET["gaji"]??""}}"id="exampleFormControlInput1">
                                    </div>
                                </div>
